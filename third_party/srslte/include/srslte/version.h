...
#define SRSLTE_VERSION_MAJOR 20 //@SRSLTE_VERSION_MAJOR@
#define SRSLTE_VERSION_MINOR 4 //@SRSLTE_VERSION_MINOR@
#define SRSLTE_VERSION_PATCH 1 //@SRSLTE_VERSION_PATCH@
#define SRSLTE_VERSION_STRING "20.04.1" //"@SRSLTE_VERSION_STRING@"
